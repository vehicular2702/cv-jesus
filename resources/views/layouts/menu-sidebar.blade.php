                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('dashboard') }}">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-Inicio">Inicio</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('config') }}">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-Admin">Conf. Admin</span>
                            </a>
                        </li>
